...
enum class symbol_kind_type {
    ...
    ImplicitCastExpr = 94, // ImplicitCastExpr
    AddrOfExpr = 95,       // AddrOfExpr
    DerefExpr = 96,        // DerefExpr
    SizeOfExpr = 97,       // SizeOfExpr
    KwdThen = 98,          // KwdThen
    DecltrPrec = 99,       // DecltrPrec
    FuncDeclPrec = 100,    // FuncDeclPrec
    OpUnaryPrec = 101,     // OpUnaryPrec
    PLParen = 102,         // PLParen
    PRParen = 103,         // PRParen
    PLSBracket = 104,      // PLSBracket
    PRSBracket = 105,      // PRSBracket
    YYACCEPT = 106,        // $accept
    ParseRoot = 107,       // ParseRoot
    // 107_1 = 107,        // $@1
