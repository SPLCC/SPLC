...
//
//===----------------------------------------------------------------------===//
#ifndef __SPLC_BASIC_SPLCONTEXT_HH__
#define __SPLC_BASIC_SPLCONTEXT_HH__ 1
...
class SPLCContext {
  public:
    ...
    SPLCContext(const SPLCContext &) = delete;
    SPLCContext &operator=(const SPLCContext &) = delete;
...
#endif // __SPLC_BASIC_SPLCONTEXT_HH__