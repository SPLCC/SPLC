#ifndef __SPLC_CORE_UTILS_CONT_SEQ_HH__
#define __SPLC_CORE_UTILS_CONT_SEQ_HH__ 1
...
/** \brief Type of control sequences. If `noDiagnosticColor` is nonzero, then
...
#endif /* __SPLC_CORE_UTILS_CONT_SEQ_HH__ */