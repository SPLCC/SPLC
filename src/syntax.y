...
ExtDef: Specifier ExtDecList SEMI { $$ = create_parent_node(AST_EXT_DEF, @$.first_line, 3, $1, $2, $3); }
    | Specifier Specifier ExtDecList SEMI { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.last_line, @2.last_column), "two or more data types in declaration specifiers"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; }
    | ExtDecList SEMI { splwarn(SPL_MAKE_SPLLOC(@1.first_line, @1.first_column, @1.first_line, @1.first_column), "declaration is missing a specifier and will default to int"); $$ = create_parent_node(AST_EXT_DEF, @$.first_line, 0); yyerrok; }
    | Specifier SEMI { $$ = create_parent_node(AST_EXT_DEF, @$.first_line, 2, $1, $2); } // Allowing structure definitions
    | FuncDec CompStmt { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@1.first_line, @1.first_column, @1.first_line, @1.first_column), "function is missing a specifier"); $$ = create_parent_node(AST_EXT_DEF, @$.first_line, 0); yyerrok; } 
    ...
    | Specifier error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.last_line, @2.last_column), "missing valid identifier"); $$ = create_parent_node(AST_EXT_DEF, @$.first_line, 0); yyerrok; }
    ;
...
VarDec: ID { $$ = create_parent_node(AST_VAR_DEC, @$.first_line, 1, $1); }
    ...
    | VarDec LSB INT error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.last_line, @2.last_column, @2.last_line, @2.last_column), "missing closing bracket ']'"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; } 
    | VarDec INT RSB { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '[' here"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; } 
    | VarDec RSB { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '[' here"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; } 
...
FuncDec: ID LP VarList RP { $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 4, $1, $2, $3, $4); }
    | ID LP error RP { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.first_line, @3.first_column, @3.last_line, @3.last_column), "invalid parameter declaration ')'"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; }
    | ID error RP { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '(' here"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; }
    ...
    | ID LP VarList error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.last_line, @3.last_column, @3.last_line, @3.last_column), "missing closing parenthesis ')'"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; }
    | ID LP RP { $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 3, $1, $2, $3); }
    | ID LP error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.last_line, @2.last_column, @2.last_line, @2.last_column), "missing closing parenthesis ')'"); $$ = create_parent_node(AST_FUNC_DEC, @$.first_line, 0); yyerrok; }
    ;
...
CompStmt: LC RC { $$ = create_parent_node(AST_COMP_STMT, @$.first_line, 0); }
    ...
    | LC DefList StmtList error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.last_line, @3.last_column, @3.last_line, @3.last_column), "missing closing brace '}'"); $$ = create_parent_node(AST_COMP_STMT, @$.first_line, 0); yyerrok; }
    | LC DefList StmtList DefList error RC { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.first_line, @3.first_column, @3.last_line, @3.last_column), "cannot interleave definitions with statements. "); $$ = create_parent_node(AST_COMP_STMT, @$.first_line, 0); }
    | LC StmtList DefList StmtList error RC { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.first_line, @3.first_column, @3.last_line, @3.last_column), "cannot interleave definitions with statements. "); $$ = create_parent_node(AST_COMP_STMT, @$.first_line, 0); }
    ;
...
Stmt: SEMI { $$ = create_parent_node(AST_STMT, @$.first_line, 1, $1); }
    ...
    | Exp error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@1.last_line, @1.last_column, @1.last_line, @1.last_column), "missing semicolon ';'"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }

    | CompStmt { $$ = create_parent_node(AST_STMT, @$.first_line, 1, $1); }

    | RETURN Exp SEMI { $$ = create_parent_node(AST_STMT, @$.first_line, 3, $1, $2, $3); }
    | RETURN Exp error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.last_line, @2.last_column, @2.last_line, @2.last_column), "missing semicolon ';'"); $$ = create_parent_node(AST_STMT, @$.first_line, 2, $1, $2); yyerrok; }

    | IF LP Exp RP Stmt %prec THEN { $$ = create_parent_node(AST_STMT, @$.first_line, 5, $1, $2, $3, $4, $5); }
    | IF error RP Stmt %prec THEN { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '(' here"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | IF LP Exp RP error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@4.last_line, @4.last_column, @4.last_line, @4.last_column), "if requires at least one statement to be executed"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | IF LP Exp RP Stmt ELSE Stmt { $$ = create_parent_node(AST_STMT, @$.first_line, 7, $1, $2, $3, $4, $5, $6, $7); }
    | IF error RP Stmt ELSE Stmt { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '(' here"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | IF LP Exp RP Stmt ELSE error { $$ = create_parent_node(AST_STMT, @$.first_line, 7, $1, $2, $3, $4, $5, $6, $7); }
    | IF LP Exp error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.last_line, @3.last_column, @3.last_line, @3.last_column), "missing closing parenthesis ')'"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | ELSE Stmt { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@1.first_line, @1.first_column, @1.last_line, @1.last_column), "hanging else is not allowed."); $$ = create_parent_node(AST_STMT, @$.first_line, 2, $1, $2); yyerrok; }

    | WHILE LP Exp RP Stmt { $$ = create_parent_node(AST_STMT, @$.first_line, 5, $1, $2, $3, $4, $5); }
    | WHILE error RP Stmt { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.first_line, @2.first_column, @2.first_line, @2.first_column), "expected '(' here"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | WHILE LP Exp RP error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@4.last_line, @4.last_column, @4.last_line, @4.last_column), "while loop requires at least one statement to be executed"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    ...
    | WHILE LP Exp error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.last_line, @3.last_column, @3.last_line, @3.last_column), "missing closing parenthesis ')'"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok;  }

    | FOR LP ForLoopBody RP Stmt { $$ = create_parent_node(AST_STMT, @$.first_line, 5, $1, $2, $3, $4, $5); }
    | FOR LP ForLoopBody RP error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@4.last_line, @4.last_column, @4.last_line, @4.last_column), "for loop requires at least one statement to be executed"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    | FOR LP ForLoopBody error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@3.last_line, @3.last_column, @3.last_line, @3.last_column), "missing closing parenthesis ')'"); $$ = create_parent_node(AST_STMT, @$.first_line, 0); yyerrok; }
    ;
...
Def: Specifier DecList SEMI { $$ = create_parent_node(AST_DEF, @$.first_line, 3, $1, $2, $3); }
    | Specifier DecList error { splerror(SPLC_ERR_B, SPL_MAKE_SPLLOC(@2.last_line, @2.last_column, @2.last_line, @2.last_column), "missing semicolon ';'"); $$ = create_parent_node(AST_DEF, @$.first_line, 0); yyerrok; }
    ;
